...
- (void)inputNonconformityAnimation {
    ...
    POPSpringAnimation *shakeSpringAnimation = [POPSpringAnimation animationWithPropertyNamed:kPOPLayerPositionX];
    shakeSpringAnimation.velocity = @(2000);
    shakeSpringAnimation.springBounciness = 10.0;
    shakeSpringAnimation.beginTime = CACurrentMediaTime();
    [shakeSpringAnimation setCompletionBlock:^(POPAnimation *anim, BOOL finished) {
    ...
    [self.eiTextField.layer pop_addAnimation:shakeSpringAnimation forKey:@"shakeSpringAnimation"];
}
